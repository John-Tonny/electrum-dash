...
WIF_HELP_TEXT = (_('WIF keys are typed in VPubChain, based on script type.') + '\n\n' +
                 _('A few examples') + ':\n' +
...
MSG_PASSPHRASE_WARN_ISSUE4566 = _("Warning") + ": "\
                              ...
                              + _("Due to a bug, old versions of VPubChain will NOT be creating the "
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def __init__(self, config, app, plugins, storage):
        ...
        self.setWindowTitle('VPubChain Wallet  -  ' + _('Install Wizard'))
        self.app = app
        self.config = config
    ...
    def run_and_get_wallet(self, get_wallet_from_daemon):
        ...
        self.set_layout(vbox, title=_('VPubChain wallet'))
        ...
        if self.storage.requires_split():
            self.hide()
            msg = _("The wallet '{}' contains multiple accounts, which are no longer supported since VPubChain-Wallet 2.7.\n\n"
    ...
    def init_network(self, network):
        message = _("VPubChain-Wallet communicates with remote servers to get "
                  "information about your transactions and addresses. The "
                  "servers all fulfill the same purpose only differing in "
                  "hardware. In most cases you simply want to let VPubChain-Wallet "
